...
import { FiArrowLeft, FiUser, FiMail, FiPhone, FiFileText, FiDownload, FiEye, FiCheckCircle, FiXCircle, FiClock, FiCalendar, FiMapPin, FiBriefcase } from 'react-icons/fi';
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <select
                            ...
                            onChange={(e) => cambiarEstadoPostulacion(postulacion.id, e.target.value)}
                          >
